...
-   **Think out loud:** Which continent do you think has the highest population? Which do you think has the second highest? The lowest?
    ...
    Asia should be the most populated, with Africa coming second. Oceania would be the least populated by virtue of landmass.
...
ggplot(aes(x = continent, y = total_pop)) +
  ...
  labs(
    x = "Continent",
    y = "Total Population(millions of people)"
  ) +
  scale_y_continuous(label = label_number(scale = 1/1000000))
```
...
ggplot(population_summary,aes()) +
  ...
  labs(
    ...
    x = "Total Population",
    y = "Continent",
    caption = "The World bank and Our World in Data"
  ) +
...
I would change the order of continents top-to-bottom, from highest to lowest population. If possible, bold the title or lower the subtitle font size to emphasize the title.
